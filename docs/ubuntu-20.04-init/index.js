    ...
    '/ubuntu-20.04-init': [
      {
        ...
        children: [
          ...
          '/ubuntu-20.04-init/docs/wps.md',
          '/ubuntu-20.04-init/docs/dingtalk.md',
          '/ubuntu-20.04-init/docs/nutstore.md',
          '/ubuntu-20.04-init/docs/mysql.md',
          '/ubuntu-20.04-init/docs/jetbrains.md',
          '/ubuntu-20.04-init/docs/python.md',
          '/ubuntu-20.04-init/docs/sogou_input.md',
          '/ubuntu-20.04-init/docs/qv2ray.md',
        ],
      },
    ],
  }
  module.exports.Ubuntu2004InitSidebar = Ubuntu2004InitSidebar
